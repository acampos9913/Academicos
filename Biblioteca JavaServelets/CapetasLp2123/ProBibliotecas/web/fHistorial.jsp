<%-- 
    Document   : fHistorial
    Created on : 16-jul-2014, 10:15:01
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
              ...
              <li class="active"><a href="fHistorial.jsp">Historial</a></li>
          </ul>
        ...
        <div class="col-xs-12 col-sm-9">
            ...
            <tbody>
               <%
                        ...
                        String Estado_Pre="";
                        ArrayList<entPrestamo> Lista = negPrestamo.ListarPrestamosXEstado(Estado_Pre,atrU.getCodigo_usu());
