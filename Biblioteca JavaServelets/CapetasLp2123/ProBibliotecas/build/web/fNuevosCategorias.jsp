<%-- 
    Document   : fNuevosCategorias
    Created on : 16-jul-2014, 15:09:56
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        Gen=datGenerador.GenCategoria();
        int Ultimo = Gen.getUltimo() + 1;
        String cadcodido = "CAT000";
        ...
        if(request.getParameter("btnGuardar")!=null){
                ...
                Cat.setCodigo_gen(Codigo.toString());
                ...
                try{
                    int i = datCategorias.InsertarCategoria(Cat);
                    if(i>0){
        ...
        <div class="InputsDiv">Nombres: </div><div class="InputsDiv"><input type="text" required="true" name="txtNombreCategoria"/></div>
        <div class="EspaciadorDiv"></div>
        <div class="InputsDiv">Descripcion: </div><div class="InputsDiv"><input type="text" name="txtDescipcionCategoria"/></div>
        <div class="EspaciadorDiv"></div>
