<%-- 
    Document   : fEditarAutores
    Created on : 16-jul-2014, 15:08:28
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        %>
        <form>
        <input type="hidden" name="txtCodigo" value="<%=A.getCodigo_aut()%>"/>
        <div class="InputsDiv">Codigo: </div><div class="InputsDiv"><%=A.getCodigo_aut()%></div>
        <div class="EspaciadorDiv"></div>
        <div class="InputsDiv">Nombres: </div><div class="InputsDiv"><input type="text" required="true" name="txtNombres" value="<%=A.getNombres_aut()%>"/></div>
        <div class="EspaciadorDiv"></div>
        <div class="InputsDiv">Apellidos: </div><div class="InputsDiv"><input type="text" name="txtAplellidos" value="<%=A.getApe_aut()%>"/></div>
        <div class="EspaciadorDiv"></div>
