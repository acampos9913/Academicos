<%-- 
    Document   : fNuevosEditores
    Created on : 16-jul-2014, 15:10:11
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        Gen=datGenerador.GenEditores();
        int Ultimo = Gen.getUltimo() + 1;
        String cadcodido = "EDI000";
        ...
        <div class="InputsDiv">Nombres: </div><div class="InputsDiv"><input type="text" required="true" name="txtNombreEditor"/></div>
        <div class="EspaciadorDiv"></div>
        <div class="InputsDiv">Dirección: </div><div class="InputsDiv"><input type="text" name="txtDireccionEditor"/></div>
        <div class="EspaciadorDiv"></div>
