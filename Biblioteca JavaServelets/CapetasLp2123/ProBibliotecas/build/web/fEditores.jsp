<%-- 
    Document   : fEditores
    Created on : 16-jul-2014, 11:54:30
    ...
    <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
            ...
            if(request.getParameter("idIEdi")!=null){
                try{
                    String Estado="Habilitado";
                    String Codigo=request.getParameter("idIEdi");
                    String tabla="Editores";
                    int i = datGenerador.ActualizarEstados(Estado,Codigo,tabla);
                    if(i>0){
                        //out.print("<script>Se edito correctamente el producto</script>");
    ...
    <div class="container">
      ...
      <div class="row row-offcanvas row-offcanvas-right">
        <div class="col-xs-12 col-sm-9">
            <a href="fNuevosEditores.jsp"><div>Nuevo</div></a>
            ...
            <tbody>
                <%
                        ArrayList<entEditores> Lista = negEditores.ListarEditores();
                        ...
                        for(int i=0;i<Lista.size();i++){
                            ...
                            %>
                                ...
                                <tr>
                                    <td ><%=Lista.get(i).getCodigo_edi()%></td>
                                    <td ><%=Lista.get(i).getNom_edi()%></td>
                                    <td ><%= Lista.get(i).getDireccion()%></td>
                                    <%if(Lista.get(i).getEstado_Edi().equals("Habilitado")){%>
                                    <td><a href="fEditarEditores.jsp?IdEditorial=<%=Lista.get(i).getCodigo_edi()%>"><div class="EditarDiv"></div></a></td>
                                    <td><a href="fEditores.jsp?idHEdi=<%=Lista.get(i).getCodigo_edi()%>"><div class="InabilitarDiv"></div></a></td>
                                    <%}else{%>
                                    <td><a href="#"><div class="EditarDiv"></div></a><td>
                                    <td><a href="fEditores.jsp?idIEdi=<%=Lista.get(i).getCodigo_edi()%>"><div class="HabilitarDiv"></div></a><td>
                                    <%}%>
