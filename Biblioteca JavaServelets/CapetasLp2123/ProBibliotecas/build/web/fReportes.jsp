<%-- 
    Document   : fReportes
    Created on : 16-jul-2014, 11:55:03
...
<%@page import="paqueteDatos.conexion"%>
    ...
    <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          ...
          if(request.getParameter("idrpt")!=null){
          Connection cn=conexion.getConexion();
 
            /*Establecemos la ruta del reporte*/

            File reporte=new File(application.getRealPath("Reportes/Libros.jasper"));
            ...
            /*Enviamos la ruta del reporte, los parámetros y la conexión*/
             byte[] byte1=JasperRunManager.runReportToPdf(reporte.getPath(), parameter, cn);
            ...
            response.setContentLength(byte1.length);

            ServletOutputStream outputStream= response.getOutputStream();

            outputStream.write(byte1,0,byte1.length);
    ...
    <div class="container">
      ...
      <div class="row row-offcanvas row-offcanvas-right">
        <div class="col-xs-12 col-sm-9">
            ...
            <a href="fReportes.jsp?idrpt=Libros"><img src="Imagenes/libros.png" width="150px" height="150px"></a>
            <p>Reporte de Libros</p>
        </div>
        ...
        <div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar" role="navigation">
          <div class="list-group">
            ...
            if(Emp.getTipo_usu().equals("Bibliotecario") &&Emp!=null){%>
              ...
              %>
              <a href="fUsuarios.jsp" class="list-group-item">Usuarios</a>
              <a href="fReportes.jsp" class="list-group-item active">Reportes</a>
              <%}%>
          </div>
        </div>
      </div>
